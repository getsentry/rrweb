...
- `@sentry/rrweb` (corresponds to the [original `rrweb` package](https://www.npmjs.com/package/rrweb))
- `@sentry/rrdom` (corresponds to the [original `rrdom` package](https://www.npmjs.com/package/rrdom))
